...
export default function PokemonDetail({ onBack }: PokemonDetailProps) {
  let getLocal = localStorage.getItem("pokemonLocal")
  const pokemon: Pokemon = getLocal ? JSON.parse(getLocal) : [];
